    ...
    \begin{proof}
        ...
        \begin{figure}[here]
            ...
            \begin{tikzpicture}[shorten >=1pt,node distance=2cm,on grid,auto] 
                ...
                \node[state] (q_3) [right=of q_dots] {$q_3$}; 
                ...
                \path[->] 
                    ...
                    (q_dots)
                        edge node {\sigma_{n-1}} (q_3)
                    (q_3)
                        edge node {\sigma_n} (q_4);
            \end{tikzpicture}
            \caption{NFA, \(A\)}
            \label{fig:automataA}
        \end{figure}
        ...
        \begin{figure}[here]
            ...
            \begin{tikzpicture}[shorten >=1pt,node distance=2cm,on grid,auto] 
                ...
                \node[state] (q_dots) [right=of q_2] {$\cdots$}; 
                \node[state] (q_3) [right=of q_dots] {$q_3$}; 
                \node[state, initial] (q_4) [right=of q_3] {$q_4$}; 
                \path[->] 
                    (q_2)
...
\begin{homeworkProblem}
    ...
    \[
        \{w \in \Sigma^* | {\left|| w \right||}_01 = {\left|| w \right||}_10\}.
    \]
        ...
        \begin{tikzpicture}[shorten >=1pt,node distance=2cm,on grid,auto] 
            ...
            \path[->] 
                ...
                (q_1)
                    ...
                    edge node [bend right=-30] {0} (q_3)
                (q_2)
                    edge [loop above] node {1}
                    edge node [bend right=-30] {0} (q_4)
                (q_3)
                    edge [loop right] node {1}
                    edge node [bend left] {0} (q_1)
                (q_4)
                    edge [loop right] node {0}
                    edge node [bend left] {0} (q_2);
        \end{tikzpicture}
        \caption{NFA, \(B\)}
        \label{fig:automataB}
    \end{figure}

    This can also be shown with the pumping lemma.
