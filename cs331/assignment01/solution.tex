...
\begin{homeworkProblem}
    ...
    \begin{enumerate}
        \item
            ...
            The language is the set of all words that have at least one 0 and
            one 1 in them and the 0 comes before the 1.
        \item \(0 0^{*} 1^{*}\) \\
            The language is the set of all words that begin with a zero. The
            word also ends with any number of zeroes (including none) followed
            by any number of ones (including none).
    \end{enumerate}
\end{homeworkProblem}
