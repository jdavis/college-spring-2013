...
\begin{homeworkProblem}
    Prove that \(EULERIAN-PATH = \{\langle G \rangle : G \mbox{ has an Eulerian path}\}\) is in \(P\).
...
\begin{homeworkProblem}
    Let \(TSP = \{ \langle G, K \rangle : G \mbox{ has a Hamiltonian path of length less than } k\}\).
    \\
