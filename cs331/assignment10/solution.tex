...
\begin{homeworkProblem}
    ...
    \begin{proof}
        ...
        \textbf{Base Case} We consider the base case with three vertices
        connected by an edge between all of them.
        \\

        Since there are three edges and three vertices, the graph is in the
        form of a triangle. If we count the degree for each vertex we can see
        that the number equals two for all three vertices. Thus it holds for
        the base case.
        \\

        \textbf{Induction Step} We now consider a graph with some number of
        vertices and wish to show that 
        \\
