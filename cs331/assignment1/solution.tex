...
\end{homeworkProblem}
    \begin{proof}
        ...
        \textbf{Induction Step} Given the positive propositional formula \(\Delta\) and
        two truth assignments, \(M\) and \(M'\) such that \(M \leq M'\).

        We will show that for any positive propositional formula, \(M \models M'\).

        Taking \(\Delta\), we can do one of two things to extend the propositional
